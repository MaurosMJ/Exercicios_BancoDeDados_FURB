...
-- Inserindo Gêneros
INSERT INTO genero (cd_genero, ds_genero) VALUES (genero_seq.NEXTVAL, 'Ação');
INSERT INTO genero (cd_genero, ds_genero) VALUES (genero_seq.NEXTVAL, 'Comédia');
INSERT INTO genero (cd_genero, ds_genero) VALUES (genero_seq.NEXTVAL, 'Drama');

-- Inserindo Censuras
INSERT INTO censura (cd_censura, ds_censura) VALUES (censure_seq.NEXTVAL, 'Livre');
INSERT INTO censura (cd_censura, ds_censura) VALUES (censure_seq.NEXTVAL, '12 anos');
INSERT INTO censura (cd_censura, ds_censura) VALUES (censure_seq.NEXTVAL, '16 anos');

-- Inserindo Atores
INSERT INTO ator (cd_ator, nm_ator) VALUES (ator_seq.NEXTVAL, 'Ator 1');
INSERT INTO ator (cd_ator, nm_ator) VALUES (ator_seq.NEXTVAL, 'Ator 2');
INSERT INTO ator (cd_ator, nm_ator) VALUES (ator_seq.NEXTVAL, 'Ator 3');
INSERT INTO ator (cd_ator, nm_ator) VALUES (ator_seq.NEXTVAL, 'Ator 4');
INSERT INTO ator (cd_ator, nm_ator) VALUES (ator_seq.NEXTVAL, 'Ator 5');

-- Inserindo Filmes
INSERT INTO filme (cd_filme, cd_censura, cd_genero, nm_filme, ds_sinopse, nr_duracao, dt_lancamento, fl_dublado) 
VALUES (filme_seq.NEXTVAL, 1, 1, 'Filme 1', 'Sinopse do Filme 1', '120 min', TO_DATE('2024-01-01', 'YYYY-MM-DD'), 'S');

INSERT INTO filme (cd_filme, cd_censura, cd_genero, nm_filme, ds_sinopse, nr_duracao, dt_lancamento, fl_dublado) 
VALUES (filme_seq.NEXTVAL, 2, 2, 'Filme 2', 'Sinopse do Filme 2', '90 min', TO_DATE('2024-02-01', 'YYYY-MM-DD'), 'N');

INSERT INTO filme (cd_filme, cd_censura, cd_genero, nm_filme, ds_sinopse, nr_duracao, dt_lancamento, fl_dublado) 
VALUES (filme_seq.NEXTVAL, 3, 3, 'Filme 3', 'Sinopse do Filme 3', '150 min', TO_DATE('2024-03-01', 'YYYY-MM-DD'), 'S');

INSERT INTO filme (cd_filme, cd_censura, cd_genero, nm_filme, ds_sinopse, nr_duracao, dt_lancamento, fl_dublado) 
VALUES (filme_seq.NEXTVAL, 1, 1, 'Filme 4', 'Sinopse do Filme 4', '110 min', TO_DATE('2024-04-01', 'YYYY-MM-DD'), 'N');

INSERT INTO filme (cd_filme, cd_censura, cd_genero, nm_filme, ds_sinopse, nr_duracao, dt_lancamento, fl_dublado) 
VALUES (filme_seq.NEXTVAL, 2, 2, 'Filme 5', 'Sinopse do Filme 5', '130 min', TO_DATE('2024-05-01', 'YYYY-MM-DD'), 'S');

-- Associando Atores aos Filmes
INSERT INTO filme_ator (cd_filme, cd_ator) VALUES (1, 1);
INSERT INTO filme_ator (cd_filme, cd_ator) VALUES (1, 2);
INSERT INTO filme_ator (cd_filme, cd_ator) VALUES (2, 3);
INSERT INTO filme_ator (cd_filme, cd_ator) VALUES (3, 4);
INSERT INTO filme_ator (cd_filme, cd_ator) VALUES (4, 5);
INSERT INTO filme_ator (cd_filme, cd_ator) VALUES (5, 1);
